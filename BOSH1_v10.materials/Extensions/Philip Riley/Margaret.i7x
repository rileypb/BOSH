...
The screwdriver is in the Room of Stuff.

Margaret the temp is a woman. The description is "[Margaret the temp], whose last name no one in the Bureau has bothered to learn, is the latest temporary worker working the front desk. Not that anyone ever comes in here except by mistake. Most of [their] job involves ordering stationery and office supplies, shredding documents, and keeping track of office equipment."

Rule for printing the name of Margaret the temp: say "Margaret".

Margaret the temp is familiar.

The help text of Margaret is "[Margaret] is the latest temp worker running the front office.".
