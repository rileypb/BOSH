...
Definition: something is farseeable if it is viewable from the location.

After deciding the scope of the player (this is the add farseeable to scope rule):
	repeat with X running through farseeable things:
		place X in scope;
