...
name (a text)	discussion (a text)
"Abominable Snowman"	"The Abominable Snowman, also known as the Yeti, is a white-furred, ape-like creature inhabiting the Himalayan mountain range. It is the subject of numerous sightings, but skeptics argue that the evidence is inconclusive."
...
"Ouija board"	"The Ouija board is a flat board marked with the letters of the alphabet, the numbers 0-9, the words 'yes', 'no', and 'goodbye', and other symbols. It is used to communicate with the spirits of the dead. It totally works, I swear."
