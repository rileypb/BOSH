Version 4.0.220604 of Inclusive Gender Options by Nathanael Nerode begins here.
...
The nomale property translates into Inter as "nomale".
...
A person is usually not female.
A person is usually not male.
...
The third singular pronoun property translates into Inter as "third_singular_pronoun".
...
Part 3 Core i6 Parser Fix (for use without Original Parser by Ron Newcomb)
...
[This is the primary logic change, allowing male, female, nonbinary, and neuter to be four separate bits, properly.]
...
Part 4 Original Parser Fix (for use with Original Parser by Ron Newcomb)
...
"Singular" or "Plural"
"Male", "Female", "nonBinary", or "Neuter"
]
...
To set pronouns from (obj - an object) (this is PronounNotice):
	...
	repeat through all four columns of the language's pronoun list:
