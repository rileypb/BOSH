...
unsayability relates various people to various quips. The verb to avoid implies the unsayability relation.

An availability rule for a quip (called Q): 
	if the player avoids Q:
		it is off-limits;
